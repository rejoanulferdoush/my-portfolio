    ...
    <section className="py-16" id="about">
      ...
      <Container>
        <Row>
          ...
          <Col className="md:w-1/2 text-gray-900 text-3xl mb-16">
            ...
            <Fade direction="right" triggerOnce="true">
              <p className="mb-5">
                ...
                creating dynamic and engaging websites. I have extensive
                knowledge of React and have successfully completed various
                projects using it. Additionally, I am well-versed in working
                with popular content management systems (CMS) such as WordPress.
              </p>
            </Fade>
            <Fade direction="right" triggerOnce="true">
              <p>
